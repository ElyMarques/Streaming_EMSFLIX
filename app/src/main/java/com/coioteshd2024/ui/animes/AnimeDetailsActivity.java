...
import com.coioteshd2024.ui.seriedetails.RelatedsSeriesAdapter;
...
public class AnimeDetailsActivity extends AppCompatActivity {
    ...
    private void onLoadImage(String imageURL){
        ...
        CustomTarget<Bitmap> bitmap = GlideApp.with(getApplicationContext())
                ...
                .into(new CustomTarget<Bitmap>() {
                    ...
                    public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                        ...
                        Tools.onLoadMediaCoverBlur(AnimeDetailsActivity.this, binding.imageMoviePoster, bitmapx[0]);
                    }
        ...
        Tools.onLoadMediaCover(this,binding.itemMovieImage,anime.getPosterPath());
