...
import com.coioteshd2024.ui.downloadmanager.core.HttpConnection;
import com.coioteshd2024.ui.downloadmanager.core.model.data.DownloadResult;
import com.coioteshd2024.ui.downloadmanager.core.model.data.PieceResult;
import com.coioteshd2024.ui.downloadmanager.core.model.data.StatusCode;
import com.coioteshd2024.ui.downloadmanager.core.model.data.entity.DownloadInfo;
import com.coioteshd2024.ui.downloadmanager.core.model.data.entity.DownloadPiece;
import com.coioteshd2024.ui.downloadmanager.core.model.data.entity.Header;
import com.coioteshd2024.ui.downloadmanager.core.settings.SettingsRepository;
import com.coioteshd2024.ui.downloadmanager.core.storage.DataRepository;
import com.coioteshd2024.ui.downloadmanager.core.system.FileDescriptorWrapper;
import com.coioteshd2024.ui.downloadmanager.core.system.FileSystemFacade;
import com.coioteshd2024.ui.downloadmanager.core.system.SystemFacade;
import com.coioteshd2024.ui.downloadmanager.core.utils.DateUtils;
import com.coioteshd2024.ui.downloadmanager.core.utils.DownloadUtils;
import com.coioteshd2024.ui.downloadmanager.core.utils.MimeTypeUtils;
...
import static com.coioteshd2024.ui.downloadmanager.core.model.data.StatusCode.STATUS_BAD_REQUEST;
import static com.coioteshd2024.ui.downloadmanager.core.model.data.StatusCode.STATUS_CANNOT_RESUME;
import static com.coioteshd2024.ui.downloadmanager.core.model.data.StatusCode.STATUS_FETCH_METADATA;
import static com.coioteshd2024.ui.downloadmanager.core.model.data.StatusCode.STATUS_FILE_ERROR;
import static com.coioteshd2024.ui.downloadmanager.core.model.data.StatusCode.STATUS_HTTP_DATA_ERROR;
import static com.coioteshd2024.ui.downloadmanager.core.model.data.StatusCode.STATUS_PAUSED;
import static com.coioteshd2024.ui.downloadmanager.core.model.data.StatusCode.STATUS_RUNNING;
import static com.coioteshd2024.ui.downloadmanager.core.model.data.StatusCode.STATUS_STOPPED;
import static com.coioteshd2024.ui.downloadmanager.core.model.data.StatusCode.STATUS_SUCCESS;
import static com.coioteshd2024.ui.downloadmanager.core.model.data.StatusCode.STATUS_TOO_MANY_REDIRECTS;
import static com.coioteshd2024.ui.downloadmanager.core.model.data.StatusCode.STATUS_UNHANDLED_HTTP_CODE;
import static com.coioteshd2024.ui.downloadmanager.core.model.data.StatusCode.STATUS_UNKNOWN_ERROR;
import static com.coioteshd2024.ui.downloadmanager.core.model.data.StatusCode.STATUS_WAITING_FOR_NETWORK;
import static com.coioteshd2024.ui.downloadmanager.core.model.data.StatusCode.STATUS_WAITING_TO_RETRY;
