...
import com.coioteshd2024.ui.downloadmanager.core.filter.DownloadFilter;
import com.coioteshd2024.ui.downloadmanager.core.filter.DownloadFilterCollection;
...
import com.coioteshd2024.ui.downloadmanager.core.sorting.DownloadSorting;
import com.coioteshd2024.ui.downloadmanager.core.sorting.DownloadSortingComparator;
import com.coioteshd2024.ui.downloadmanager.core.system.FileSystemFacade;
import com.coioteshd2024.ui.downloadmanager.core.system.SafFileSystem;
...
import com.coioteshd2024.ui.downloadmanager.receiver.BootReceiver;
import com.coioteshd2024.ui.downloadmanager.ui.main.DownloadItem;
import com.coioteshd2024.ui.downloadmanager.ui.main.drawer.DrawerGroup;
import com.coioteshd2024.ui.downloadmanager.ui.main.drawer.DrawerGroupItem;
...
import static com.coioteshd2024.ui.downloadmanager.core.utils.MimeTypeUtils.DEFAULT_MIME_TYPE;
import static com.coioteshd2024.ui.downloadmanager.core.utils.MimeTypeUtils.MIME_TYPE_DELIMITER;
...
public class Utils {
    ...
    public static void enableBrowserLauncherIcon(@NonNull Context context, boolean enable) {
        ...
        pm.setComponentEnabledSetting(
                new ComponentName(context, "com.coioteshd2024.ui.downloadmanager.ui.browser.BrowserIcon"),
    ...
    public static void disableBrowserFromSystem(@NonNull Context context, boolean disable) {
        ...
        int flag = (disable ?
                ...
                PackageManager.COMPONENT_ENABLED_STATE_ENABLED);
        pm.setComponentEnabledSetting(
                new ComponentName(context, "com.coioteshd2024.ui.downloadmanager.ui.browser.Browser"),
                flag, PackageManager.DONT_KILL_APP);
    }
