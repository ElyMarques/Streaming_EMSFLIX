...
import static com.coioteshd2024.util.Constants.DEFAULT_WEBVIEW_ADS_RUNNING;
...
import com.coioteshd2024.databinding.RowSeasonsBinding;
...
import com.coioteshd2024.ui.downloadmanager.ui.adddownload.AddDownloadActivity;
import com.coioteshd2024.ui.downloadmanager.ui.adddownload.AddDownloadDialog;
import com.coioteshd2024.ui.downloadmanager.ui.adddownload.AddInitParams;
...
public class EpisodeAdapter extends RecyclerView.Adapter<EpisodeAdapter.EpisodeViewHolder> {
    ...
    class EpisodeViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(final int position) {
            ...
            download = new Download(String.valueOf(episode.getId()),String.valueOf(episode.getId()),episode.getStillPath(),currentTvShowName + " : " + "T" +
            ...
            if (settingsManager.getSettings().getEnableDownload() == 0) {
                ...
                binding.downloadEpisode.setVisibility(View.VISIBLE);
            ...
            binding.miniPlay.setOnClickListener(v -> {
                ...
                popup.getMenu().findItem(R.id.episode_comments).setVisible(settingsManager.getSettings().getEnableComments() != 1);
...
//                    break;
                case R.id.report_menu:
                    ...
                    dialog.setContentView(R.layout.dialog_report_ep);
                    ...
                    Tools.onLoadMediaCoverEpisode(context,imageView,episode.getStillPath());
                ...
                case R.id.episode_comments:
                    ...
                    if (tokenManager.getToken().getAccessToken() != null) {
                        ...
                        Toast.makeText(context, "Pra comentar você precisa fazer login !", Toast.LENGTH_SHORT).show();
                    }
...
//        }
                    ...
                    .subscribe(new Observer<>() {
                        ...
                        public void onNext(@NotNull Resume resume) {
                            ...
                            if (resume.getTmdb() != null && resume.getResumePosition() != null
                                ...
                                binding.episodeWatchedIcon.setVisibility(View.VISIBLE);
        ...
        private void onLoadChromcast(Episode episode, CastSession castSession, String link) {
            ...
            String name = currentTvShowName + " : " +"T" + currentSeasons + "E" + episode.getEpisodeNumber() + " : " + episode.getName();
            ...
            mediaRepository.hasResume(episode.getId()).observe((SerieDetailsActivity) context, resumeInfo -> {
                ...
                if (resumeInfo != null) {
                    ...
                    if (resumeInfo.getTmdb() != null && resumeInfo.getResumePosition() !=null
                        ...
                        binding.resumeProgressBar.setProgress((int) moveProgress);
                        binding.episodeWatchedIcon.setVisibility(View.VISIBLE);
                        binding.epcoveroverlay.setVisibility(View.VISIBLE);
                        ...
                        binding.resumeProgressBar.setProgress(0);
                        binding.episodeWatchedIcon.setVisibility(GONE);
                        binding.resumeProgressBar.setVisibility(GONE);
                        binding.epcoveroverlay.setVisibility(GONE);
                        binding.timeRemaning.setVisibility(GONE);
        ...
        private void onLoadMainPlayerStream(Episode episode, int position, String url, EpisodeStream episodeStream) {
            ...
            String artwork = episode.getStillPath();
            String type = "1";
            String name = "T" + currentSeasons + "E" + episode.getEpisodeNumber() + " : " + episode.getName();
    ...
    private void fillInitParams(AddInitParams params, Episode episode, String downloadUrl, EpisodeStream episodeStream)
    {
        ...
        String ePname = "T" + currentSeasons + "E" + episode.getEpisodeNumber() + " : " + episode.getName();

        String name = "T" + currentSeasons + "E" + episode.getEpisodeNumber() + "_" + episode.getName();
