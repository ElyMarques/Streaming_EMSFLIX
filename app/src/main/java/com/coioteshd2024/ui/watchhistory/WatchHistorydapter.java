package com.coioteshd2024.ui.watchhistory;
...
import com.coioteshd2024.databinding.ItemHistoryBinding;
    ...
    class MainViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(final int position) {
            ...
            if (history.getType().equals("0")) {
             ...
             binding.filmename.setText(history.getTitle());
             binding.filmename.setVisibility(View.VISIBLE);
             binding.seriename.setVisibility(View.GONE);

            }else {


                String name = history.getSeasonsNumber() + "E" + history.getEpisodeNmber() + " | " + history.getEpisodeName();
                binding.movietitle.setText(name);
                binding.seriename.setText(history.getSerieName());
                binding.filmename.setVisibility(View.GONE);
