package com.coioteshd2024.ui.settings;

import static android.view.View.GONE;
import static com.coioteshd2024.util.Constants.AUTO_PLAY;
import static com.coioteshd2024.util.Constants.EXTENTIONS;
import static com.coioteshd2024.util.Constants.PLAYER_ASPECT_RATIO;
import static com.coioteshd2024.util.Constants.PREMUIM;
import static com.coioteshd2024.util.Constants.SOFTWARE_EXTENTIONS;
import static com.coioteshd2024.util.Constants.SUBSCRIPTIONS;
import static com.coioteshd2024.util.Constants.SUBS_BACKGROUND;
import static com.coioteshd2024.util.Constants.SUBS_DEFAULT_LANG;
import static com.coioteshd2024.util.Constants.SUBS_SIZE;
import static com.coioteshd2024.util.Constants.SWITCH_PUSH_NOTIFICATION;
import static com.coioteshd2024.util.Constants.WIFI_CHECK;
...
import com.coioteshd2024.data.model.substitles.ImdbLangs;
import com.coioteshd2024.data.repository.AuthRepository;
import com.coioteshd2024.data.repository.SettingsRepository;
import com.coioteshd2024.databinding.ActivitySettingBinding;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.subcribeButton.setOnClickListener(v -> startActivity(new Intent(SettingsActivity.this, Pix.class)));

        binding.btnLogin.setOnClickListener(v -> startActivity(new Intent(SettingsActivity.this, LoginActivity.class)));

        binding.grupo.setOnClickListener(v -> {

            if (settingsManager.getSettings().getFacebookUrl() !=null &&  !settingsManager.getSettings().getFacebookUrl().trim().isEmpty()) {

                this.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(settingsManager.getSettings().getFacebookUrl())));


            }else {

                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://ultraflix.net/grupo/")));
    ...
    private void onLoadBackButton() {
        ...
        binding.backbutton.setOnClickListener(v -> {
            onBackPressed();
            Animatoo.animateSplit(SettingsActivity.this);
    ...
    private void onCheckAuth() {
        ...
        loginViewModel.authDetailMutableLiveData.observe(this, auth -> {
            ...
            if (auth !=null) {
                ...
                binding.authName.setText("Olá, "+auth.getName());
                ...
                if (auth.getPremuim() == 1) {
                    ...
                    if (auth.getExpiredIn() != null && !auth.getExpiredIn().trim().isEmpty()) {
                        ...
                        try {
                            ...
                            binding.membershipExpireIn.setText("Válido até : "+sdf2.format(releaseDate));
                        } catch (ParseException e) {
    ...
    private void setSoftwareCodec() {
        ...
        if (!sharedPreferences.getBoolean(SOFTWARE_EXTENTIONS, true)) {
            binding.switchCodecSoftware.setChecked(true);
        }
    ...
    private void setExtentions() {
        ...
        if (!sharedPreferences.getBoolean(EXTENTIONS, true)) {
            binding.switchPushExtentions.setChecked(true);
        }
