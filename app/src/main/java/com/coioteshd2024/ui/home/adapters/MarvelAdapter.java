 ...
 * @author Yobex.
 */
public class MarvelAdapter extends RecyclerView.Adapter<MarvelAdapter.MainViewHolder> {
    ...
    public MarvelAdapter(SettingsManager settingsManager, AppController appController) {
    ...
    @NonNull
    @Override
    public MarvelAdapter.MainViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        ItemMovieBinding binding = ItemMovieBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);

        return new MarvelAdapter.MainViewHolder(binding);
