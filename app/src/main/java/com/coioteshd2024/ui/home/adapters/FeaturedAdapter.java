...
import com.coioteshd2024.databinding.RowItemFeaturedBinding;
    ...
    class FeaturedViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(final int position) {
            ...
            if (settingsManager.getSettings().getEnableDownload() == 0) {
                ...
                binding.PlayButtonIconLinear.setVisibility(View.VISIBLE);
            ...
            binding.addToFavorite.setOnClickListener(v -> {
                ...
                if (settingsManager.getSettings().getFavoriteonline() == 1 && tokenManager.getToken().getAccessToken() != null) {
                    ...
                    if (isMovieFav) {
                        ...
                        binding.addToFavorite.setImageResource(R.drawable.ic_add);
