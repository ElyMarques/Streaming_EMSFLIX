...
import com.coioteshd2024.databinding.ItemLastestEpisodesBinding;
...
public class SeriesWithNewEpisodesAdapter extends RecyclerView.Adapter<SeriesWithNewEpisodesAdapter.StreamingViewHolder> {
    ...
    class StreamingViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(final int position) {
            ...
            String name = "T" + latestEpisodes.getSeasonNumber() + "E" + latestEpisodes.getEpisodeNumber() + " | " + latestEpisodes.getEpisodeName();
            binding.movietitle.setText(name);
            binding.seriename.setText(latestEpisodes.getName());
        ...
        private void onStartNormalLink(LatestEpisodes media, String link, int position) {
            ...
            String name = "T" + media.getSeasonNumber() + "E" + media.getEpisodeNumber() + " | " + media.getEpisodeName();
