package com.coioteshd2024.ui.home;

import static android.view.View.GONE;
import static android.view.View.VISIBLE;
import static android.view.ViewGroup.LayoutParams.MATCH_PARENT;
import static android.view.ViewGroup.LayoutParams.WRAP_CONTENT;
import static com.coioteshd2024.util.Constants.BRX;
import static com.coioteshd2024.util.Constants.SUBSCRIPTIONS;
...
import com.coioteshd2024.databinding.FragmentHomeBinding;
import com.coioteshd2024.databinding.IncludeDrawerHeaderBinding;
import com.coioteshd2024.di.Injectable;
import com.coioteshd2024.ui.animes.AnimesAdapter;
import com.coioteshd2024.ui.casts.AllCastersAdapter;
import com.coioteshd2024.ui.downloadmanager.core.utils.Utils;
import com.coioteshd2024.ui.home.adapters.AnimesWithNewEpisodesAdapter;
import com.coioteshd2024.ui.home.adapters.ByGenreAdapter;
import com.coioteshd2024.ui.home.adapters.ChoosedAdapter;
import com.coioteshd2024.ui.home.adapters.EpisodesGenreAdapter;
import com.coioteshd2024.ui.home.adapters.FeaturedAdapter;
import com.coioteshd2024.ui.home.adapters.GratisAdapter;
import com.coioteshd2024.ui.home.adapters.LatestAdapter;
import com.coioteshd2024.ui.home.adapters.LatestseriesAdapter;
import com.coioteshd2024.ui.home.adapters.MainAdapter;
import com.coioteshd2024.ui.home.adapters.MarvelAdapter;
import com.coioteshd2024.ui.home.adapters.NewThisWeekAdapter;
import com.coioteshd2024.ui.home.adapters.NovelasAdapter;
import com.coioteshd2024.ui.home.adapters.PinnedAdapter;
import com.coioteshd2024.ui.home.adapters.PopularCastersAdapter;
import com.coioteshd2024.ui.home.adapters.PopularMoviesAdapter;
import com.coioteshd2024.ui.home.adapters.PopularSeriesAdapter;
import com.coioteshd2024.ui.home.adapters.SeriesWithNewEpisodesAdapter;
import com.coioteshd2024.ui.home.adapters.TopTeenAdapter;
import com.coioteshd2024.ui.home.adapters.TopTeenSeriesAdapter;
import com.coioteshd2024.ui.home.adapters.TrendingAdapter;
...
import com.coioteshd2024.ui.manager.StatusManager;
import com.coioteshd2024.ui.manager.TokenManager;
import com.coioteshd2024.ui.networks.NetworksAdapter;
import com.coioteshd2024.ui.plans.PlansAdapter;
...
import com.coioteshd2024.ui.streaming.LatestStreamingAdapter;
import com.coioteshd2024.ui.streaming.StreamingGenresHomeAdapter;
import com.coioteshd2024.ui.upcoming.UpcomingAdapter;
import com.coioteshd2024.ui.users.MenuHandler;
...
import com.coioteshd2024.ui.watchhistory.WatchHistorydapter;
import com.coioteshd2024.util.AppController;
import com.coioteshd2024.util.DialogHelper;
import com.coioteshd2024.util.ItemAnimation;
...
public class HomeFragment extends Fragment implements Injectable {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        topTeenSeriesAdapter = new TopTeenSeriesAdapter();
        ...
        novelasAdapter = new NovelasAdapter(settingsManager,appController);
        marvelAdapter = new MarvelAdapter(settingsManager,appController);
        gratisAdapter = new GratisAdapter(settingsManager,appController);
        ...
        if (NetworkUtils.isConnectionAvailable(requireActivity())) {
            ...
            bindingHeader.btnSubscribe.setOnClickListener(v -> {
                if (tokenManager.getToken().getAccessToken() == null) {
                    // O token de acesso é nulo, redirecionar o usuário para a tela de login
                    Intent intent = new Intent(requireActivity(), LoginActivity.class);
                    startActivity(intent);
                } else {
                    // O token de acesso existe, prosseguir para a tela Pix
                    Intent intent = new Intent(requireActivity(), Pix.class);
                    startActivity(intent);
                }
            });
        }
    ...
    private void onLoadMoviesByGenres() {
        ...
        binding.marvelAll.setOnClickListener(v -> {
            ...
            mGenreType.setText("Marvel");

            genresViewModel.searchQuery.setValue("marvel");
            genresViewModel.getByGenresitemPagedList().observe(getViewLifecycleOwner(), genresList -> {
        ...
        binding.gratisAll.setOnClickListener(v -> {
            ...
            mGenreType.setText("Gratis");

            genresViewModel.searchQuery.setValue("gratis");
            genresViewModel.getByGenresitemPagedList().observe(getViewLifecycleOwner(), genresList -> {
        ...
        binding.novelasAll.setOnClickListener(v -> {
            ...
            mGenreType.setText("Novelas");

            genresViewModel.searchQuery.setValue("novelas");
            genresViewModel.getByGenresitemPagedList().observe(getViewLifecycleOwner(), genresList -> {
...
//            onLoadLatestStreaming(); //depois colocar esse trecho pra aparecer os canais
        }else {
    ...
    private void onLoadRecycleViews() {
        ...
        binding.rvMarvel.setLayoutManager(new LinearLayoutManager(requireActivity(), LinearLayoutManager.HORIZONTAL, false));
        binding.rvMarvel.addItemDecoration(new SpacingItemDecoration(1, Tools.dpToPx(requireActivity(), 0), true));


        binding.rvGratis.setHasFixedSize(true);
        binding.rvGratis.setLayoutManager(new LinearLayoutManager(requireActivity(), LinearLayoutManager.HORIZONTAL, false));
        binding.rvGratis.addItemDecoration(new SpacingItemDecoration(1, Tools.dpToPx(requireActivity(), 0), true));

        binding.rvTv.setHasFixedSize(true);
        binding.rvTv.setLayoutManager(new LinearLayoutManager(requireActivity(), LinearLayoutManager.HORIZONTAL, false));
        binding.rvTv.addItemDecoration(new SpacingItemDecoration(1, Tools.dpToPx(requireActivity(), 0), true));


        binding.rvNovelas.setHasFixedSize(true);
        binding.rvNovelas.setLayoutManager(new LinearLayoutManager(requireActivity(), LinearLayoutManager.HORIZONTAL, false));
        binding.rvNovelas.addItemDecoration(new SpacingItemDecoration(1, Tools.dpToPx(requireActivity(), 0), true));
    }




    private void onLoadNovelas() {

        binding.rvNovelas.setAdapter(novelasAdapter);

        homeViewModel.homeContentMutableLiveData.observe(getViewLifecycleOwner()
                , networks ->
                        novelasAdapter.addMain(networks.getNovelas(),requireActivity()));
    }

    private void onLoadMarvel() {

        binding.rvMarvel.setAdapter(marvelAdapter);

        homeViewModel.homeContentMutableLiveData.observe(getViewLifecycleOwner()
                , networks ->
                        marvelAdapter.addMain(networks.getMarvel(),requireActivity()));
    }

    private void onLoadGratis() {

        binding.rvGratis.setAdapter(gratisAdapter);

        homeViewModel.homeContentMutableLiveData.observe(getViewLifecycleOwner()
                , networks ->
                        gratisAdapter.addMain(networks.getGratis(),requireActivity()));
    }
    ...
    private void topTeenSeries() {

        binding.rvTv.setAdapter(topTeenSeriesAdapter);
        homeViewModel.homeContentMutableLiveData.observe(getViewLifecycleOwner()
                , latestMoviesSeries -> {
                    topTeenSeriesAdapter.addMain(latestMoviesSeries.getTop10series(), requireActivity());

                    if (topTeenSeriesAdapter.getItemCount() == 0){


                        binding.rvTvLinear.setVisibility(GONE);
                        binding.rvTv.setVisibility(GONE);
                    }else {

                        binding.rvTvLinear.setVisibility(VISIBLE);
                        binding.rvTv.setVisibility(VISIBLE);
                    }
                });
        ...
        if (settingsManager.getSettings().getProfileSelection() == 1 && authManager.getSettingsProfile().getId() !=null &&  moviesListViewModel.getHistoryWatchForProfiles() !=null) {
            ...
            moviesListViewModel.getHistoryWatchForProfiles().observe(getViewLifecycleOwner(), history -> {
                ...
                if (historydapter.getItemCount() == 0) {
                    ...
                    binding.coutinueWatchingTitle.setText(getString(R.string.continue_watching) + " para " + authManager.getSettingsProfile().getName());
