 ...
 * @author Yobex.
 */
public class GratisAdapter extends RecyclerView.Adapter<GratisAdapter.MainViewHolder> {
    ...
    public GratisAdapter(SettingsManager settingsManager, AppController appController) {
    ...
    @NonNull
    @Override
    public GratisAdapter.MainViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        ItemMovieBinding binding = ItemMovieBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);

        return new GratisAdapter.MainViewHolder(binding);
