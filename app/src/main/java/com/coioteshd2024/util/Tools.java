package com.coioteshd2024.util;
...
import static com.coioteshd2024.util.Constants.FIREBASECONFIG;
...
import static com.coioteshd2024.util.Constants.SERVER_FIREBASE_VALUE;
...
import static com.coioteshd2024.util.Constants.VLC_INTENT;
...
import com.coioteshd2024.BuildConfig;
...
import com.coioteshd2024.databinding.ItemAnimeDetailBinding;
import com.coioteshd2024.databinding.ItemMovieDetailBinding;
import com.coioteshd2024.databinding.ItemStreamDetailBinding;
...
public class Tools {
    ...
    public static void onLoadMediaCoverBlur(Context context, ImageView
            imageView, Bitmap mediaCoverPath){

        Bitmap bitmapBlur = new BlurImage().blur(context,
                mediaCoverPath, 25f); // // radius should be >0.0F && <= 25.0F

        GlideApp.with(context).asBitmap().load(bitmapBlur)
                .fitCenter()
    ...
    public static void onLoadDialogBlur(Context context, ImageView
            imageView, Bitmap dialogBlur){

        Bitmap bitmapBlur = new BlurImage().blur(context,
                dialogBlur, 25f); // // radius should be >0.0F && <= 25.0F
    ...
    public static void loadUserAvatar(Context context,ImageView imageView,String url){
        ...
        GlideApp.with(context).asBitmap().load(url).centerCrop()
                .placeholder(R.drawable.gon).into(new BitmapImageViewTarget(imageView) {
            @Override
