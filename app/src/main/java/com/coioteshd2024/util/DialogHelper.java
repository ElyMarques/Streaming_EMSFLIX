...
import com.coioteshd2024.BenefitPremiumActivity;
...
public class DialogHelper {
    ...
    public static void  showPremuimWarning(@NonNull Context context) {
        ...
        dialog.findViewById(R.id.view_benefit).setOnClickListener(v -> {
            context.startActivity(new Intent(context, BenefitPremiumActivity.class));
            dialog.dismiss();
